...
class Anton_MyBlog_Block_Adminhtml_Post_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getHeaderText()
    {
        if (Mage::registry('post_request')->getId()) {
            return Mage::helper('myblog')->__("Edit Request # %s", $this->escapeHtml(Mage::registry('post_request')->getId()));
        } else {
