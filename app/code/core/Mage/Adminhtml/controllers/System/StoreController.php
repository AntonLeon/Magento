    ...
    public function editStoreAction()
    {
        ...
        switch (Mage::registry('store_type')) {
            case 'website':
                ...
                $codeBase   = Mage::helper('core')->__('Before modifying the website code please make sure that it is not used in indexController.php.');
                break;
            case 'group':
            ...
            case 'store':
                ...
                $codeBase   = Mage::helper('core')->__('Before modifying the store view code please make sure that it is not used in indexController.php.');
                break;
        }
        if (null !== $itemId) {
            $model->load($itemId);
