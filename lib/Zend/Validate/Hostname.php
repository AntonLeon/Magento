...
class Zend_Validate_Hostname extends Zend_Validate_Abstract
{
     ...
     * (.DK) Danmark http://www.dk-hostmaster.dk/indexController.php?id=151
     ...
     * (.ORG) International http://www.pir.org/indexController.php?db=content/FAQs&tbl=FAQs_Registrant&id=2
     ...
     * (.TR) Turkey https://www.nic.tr/indexController.php
