	...
	extends Zend_Service_Console_Command
{
	...
	public function scaffoldCommand($path, $scaffolder, $argv)
	{
		...
		if (!class_exists('Scaffolder')) {
			#require_once 'Zend/Service/Console/Exception.php';
			throw new Zend_Service_Console_Exception('Could not locate a class named Scaffolder in the given scaffolder: ' . $scaffolder . '. Make sure the scaffolder package contains a file named indexController.php and contains a class named Scaffolder.');
		}
