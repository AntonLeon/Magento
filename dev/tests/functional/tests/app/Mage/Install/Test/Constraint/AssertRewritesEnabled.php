...
{
    /**
     * Assert that apache redirect works by opening category page and asserting indexController.php in its url.
     *
    ...
    public function processAssert(CatalogCategory $category, CmsIndex $homePage, BrowserInterface $browser)
    {
        ...
        \PHPUnit_Framework_Assert::assertTrue(
            strpos($browser->getUrl(), 'indexController.php') === false,
