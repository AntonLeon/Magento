...
class AssertProductIsPresentOnCustomWebsite extends AbstractConstraint
{
    ...
    public function processAssert(
        ...
        $browser->open(str_replace("indexController.php/", "", $productUrl));
    ...
    protected function placeFiles()
    {
        ...
        $indexPhpFile = file_get_contents($this->magentoRoot . DIRECTORY_SEPARATOR . 'indexController.php');
        ...
        file_put_contents($this->websiteFolder . DIRECTORY_SEPARATOR . "indexController.php", $indexPhpFile);
    }
